...
-- Name from the Production.Product table filtered by ProductID from 400 to 500
...
/*
Write a query that retrieves the unique combination of columns ProductSubcategoryID and Color 
